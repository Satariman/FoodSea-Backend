...
type Cache interface {
	// Get deserialises a cached value into dst. Returns (false, nil) on miss.
...
// Keys holds Redis key-prefix constants (§4.4 of architecture).
const (
	KeyCatalogProduct    = "catalog:product:"
	KeyCatalogCategories = "catalog:categories"
	KeyOffersProduct     = "offers:product:"
	KeySearch            = "search:"
	KeySession           = "session:"
)
