...
func (_u *CartUpdate) defaults() error {
	if _, ok := _u.mutation.UpdatedAt(); !ok {
		if cart.UpdateDefaultUpdatedAt == nil {
			return fmt.Errorf("ent: uninitialized cart.UpdateDefaultUpdatedAt (forgotten import ent/runtime?)")
		}
...
// defaults sets the default values of the builder before save.
func (_u *CartUpdateOne) defaults() error {
	if _, ok := _u.mutation.UpdatedAt(); !ok {
		if cart.UpdateDefaultUpdatedAt == nil {
			return fmt.Errorf("ent: uninitialized cart.UpdateDefaultUpdatedAt (forgotten import ent/runtime?)")
		}
