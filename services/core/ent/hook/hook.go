...
// The DeliveryConditionFunc type is an adapter to allow the use of ordinary
// function as DeliveryCondition mutator.
type DeliveryConditionFunc func(context.Context, *ent.DeliveryConditionMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f DeliveryConditionFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.DeliveryConditionMutation); ok {
		return f(ctx, mv)
	}
...
// The ProductNutritionFunc type is an adapter to allow the use of ordinary
// function as ProductNutrition mutator.
type ProductNutritionFunc func(context.Context, *ent.ProductNutritionMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f ProductNutritionFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.ProductNutritionMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.ProductNutritionMutation", m)
}
