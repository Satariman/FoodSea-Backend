...
type ProductQuery struct {
	...
	withSubcategory *CategoryQuery
	withBrand       *BrandQuery
	withNutrition   *ProductNutritionQuery
...
func (_q *ProductQuery) QuerySubcategory() *CategoryQuery {
	query := (&CategoryClient{config: _q.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
...
func (_q *ProductQuery) QueryBrand() *BrandQuery {
	query := (&BrandClient{config: _q.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (_q *ProductQuery) QueryNutrition() *ProductNutritionQuery {
	query := (&ProductNutritionClient{config: _q.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (_q *ProductQuery) QueryOffers() *OfferQuery {
...
func (_q *ProductQuery) Clone() *ProductQuery {
	...
	return &ProductQuery{
		...
		withSubcategory: _q.withSubcategory.Clone(),
		withBrand:       _q.withBrand.Clone(),
		withNutrition:   _q.withNutrition.Clone(),
...
func (_q *ProductQuery) WithSubcategory(opts ...func(*CategoryQuery)) *ProductQuery {
	query := (&CategoryClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	_q.withSubcategory = query
	return _q
}
...
func (_q *ProductQuery) WithBrand(opts ...func(*BrandQuery)) *ProductQuery {
	query := (&BrandClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *ProductQuery) WithNutrition(opts ...func(*ProductNutritionQuery)) *ProductQuery {
	query := (&ProductNutritionClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	_q.withNutrition = query
	return _q
}
...
func (_q *ProductQuery) WithOffers(opts ...func(*OfferQuery)) *ProductQuery {
	query := (&OfferClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *ProductQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Product, error) {
	var (
		...
		loadedTypes = [6]bool{
			_q.withCategory != nil,
			_q.withSubcategory != nil,
			_q.withBrand != nil,
			_q.withNutrition != nil,
			_q.withOffers != nil,
	...
	if query := _q.withSubcategory; query != nil {
		if err := _q.loadSubcategory(ctx, query, nodes, nil,
			func(n *Product, e *Category) { n.Edges.Subcategory = e }); err != nil {
			return nil, err
		}
	}
	if query := _q.withBrand; query != nil {
		if err := _q.loadBrand(ctx, query, nodes, nil,
			func(n *Product, e *Brand) { n.Edges.Brand = e }); err != nil {
			return nil, err
		}
	}
	if query := _q.withNutrition; query != nil {
		if err := _q.loadNutrition(ctx, query, nodes, nil,
			func(n *Product, e *ProductNutrition) { n.Edges.Nutrition = e }); err != nil {
			return nil, err
		}
	}
	if query := _q.withOffers; query != nil {
		if err := _q.loadOffers(ctx, query, nodes,
			func(n *Product) { n.Edges.Offers = []*Offer{} },
			func(n *Product, e *Offer) { n.Edges.Offers = append(n.Edges.Offers, e) }); err != nil {
			return nil, err
		}
	}
...
func (_q *ProductQuery) loadSubcategory(ctx context.Context, query *CategoryQuery, nodes []*Product, init func(*Product), assign func(*Product, *Category)) error {
	ids := make([]uuid.UUID, 0, len(nodes))
	nodeids := make(map[uuid.UUID][]*Product)
	for i := range nodes {
		if nodes[i].SubcategoryID == nil {
			continue
		}
...
func (_q *ProductQuery) loadBrand(ctx context.Context, query *BrandQuery, nodes []*Product, init func(*Product), assign func(*Product, *Brand)) error {
	ids := make([]uuid.UUID, 0, len(nodes))
	nodeids := make(map[uuid.UUID][]*Product)
	for i := range nodes {
...
func (_q *ProductQuery) loadNutrition(ctx context.Context, query *ProductNutritionQuery, nodes []*Product, init func(*Product), assign func(*Product, *ProductNutrition)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(productnutrition.FieldProductID)
	}
	query.Where(predicate.ProductNutrition(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(product.NutritionColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *ProductQuery) loadOffers(ctx context.Context, query *OfferQuery, nodes []*Product, init func(*Product), assign func(*Product, *Offer)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[uuid.UUID]*Product)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(offer.FieldProductID)
	}
	query.Where(predicate.Offer(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(product.OffersColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *ProductQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withSubcategory != nil {
			_spec.Node.AddColumnOnce(product.FieldSubcategoryID)
		}
		if _q.withBrand != nil {
			_spec.Node.AddColumnOnce(product.FieldBrandID)
		}
	}
