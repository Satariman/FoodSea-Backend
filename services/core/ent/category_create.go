...
func (_c *CategoryCreate) SetParentID(v uuid.UUID) *CategoryCreate {
	_c.mutation.SetParentID(v)
	return _c
}

// SetNillableParentID sets the "parent_id" field if the given value is not nil.
func (_c *CategoryCreate) SetNillableParentID(v *uuid.UUID) *CategoryCreate {
	if v != nil {
		_c.SetParentID(*v)
	}
	return _c
...
func (_c *CategoryCreate) AddSubcategoryProductIDs(ids ...uuid.UUID) *CategoryCreate {
	_c.mutation.AddSubcategoryProductIDs(ids...)
	return _c
}

// AddSubcategoryProducts adds the "subcategory_products" edges to the Product entity.
func (_c *CategoryCreate) AddSubcategoryProducts(v ...*Product) *CategoryCreate {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _c.AddSubcategoryProductIDs(ids...)
}
...
func (_c *CategoryCreate) createSpec() (*Category, *sqlgraph.CreateSpec) {
	...
	if nodes := _c.mutation.SubcategoryProductsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
