...
func (_u *CategoryUpdate) SetParentID(v uuid.UUID) *CategoryUpdate {
	_u.mutation.SetParentID(v)
	return _u
}

// SetNillableParentID sets the "parent_id" field if the given value is not nil.
func (_u *CategoryUpdate) SetNillableParentID(v *uuid.UUID) *CategoryUpdate {
	if v != nil {
		_u.SetParentID(*v)
	}
	return _u
...
func (_u *CategoryUpdate) AddSubcategoryProductIDs(ids ...uuid.UUID) *CategoryUpdate {
	_u.mutation.AddSubcategoryProductIDs(ids...)
	return _u
}

// AddSubcategoryProducts adds the "subcategory_products" edges to the Product entity.
func (_u *CategoryUpdate) AddSubcategoryProducts(v ...*Product) *CategoryUpdate {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _u.AddSubcategoryProductIDs(ids...)
}
...
// ClearSubcategoryProducts clears all "subcategory_products" edges to the Product entity.
func (_u *CategoryUpdate) ClearSubcategoryProducts() *CategoryUpdate {
	_u.mutation.ClearSubcategoryProducts()
	return _u
}

// RemoveSubcategoryProductIDs removes the "subcategory_products" edge to Product entities by IDs.
func (_u *CategoryUpdate) RemoveSubcategoryProductIDs(ids ...uuid.UUID) *CategoryUpdate {
	_u.mutation.RemoveSubcategoryProductIDs(ids...)
	return _u
}

// RemoveSubcategoryProducts removes "subcategory_products" edges to Product entities.
func (_u *CategoryUpdate) RemoveSubcategoryProducts(v ...*Product) *CategoryUpdate {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _u.RemoveSubcategoryProductIDs(ids...)
}
...
func (_u *CategoryUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if _u.mutation.SubcategoryProductsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
	...
	if nodes := _u.mutation.RemovedSubcategoryProductsIDs(); len(nodes) > 0 && !_u.mutation.SubcategoryProductsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   category.SubcategoryProductsTable,
	...
	if nodes := _u.mutation.SubcategoryProductsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   category.SubcategoryProductsTable,
...
// SetParentID sets the "parent_id" field.
func (_u *CategoryUpdateOne) SetParentID(v uuid.UUID) *CategoryUpdateOne {
	_u.mutation.SetParentID(v)
	return _u
}

// SetNillableParentID sets the "parent_id" field if the given value is not nil.
func (_u *CategoryUpdateOne) SetNillableParentID(v *uuid.UUID) *CategoryUpdateOne {
	if v != nil {
		_u.SetParentID(*v)
	}
	return _u
...
// AddSubcategoryProductIDs adds the "subcategory_products" edge to the Product entity by IDs.
func (_u *CategoryUpdateOne) AddSubcategoryProductIDs(ids ...uuid.UUID) *CategoryUpdateOne {
	_u.mutation.AddSubcategoryProductIDs(ids...)
	return _u
}

// AddSubcategoryProducts adds the "subcategory_products" edges to the Product entity.
func (_u *CategoryUpdateOne) AddSubcategoryProducts(v ...*Product) *CategoryUpdateOne {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearSubcategoryProducts clears all "subcategory_products" edges to the Product entity.
func (_u *CategoryUpdateOne) ClearSubcategoryProducts() *CategoryUpdateOne {
	_u.mutation.ClearSubcategoryProducts()
	return _u
}

// RemoveSubcategoryProductIDs removes the "subcategory_products" edge to Product entities by IDs.
func (_u *CategoryUpdateOne) RemoveSubcategoryProductIDs(ids ...uuid.UUID) *CategoryUpdateOne {
	_u.mutation.RemoveSubcategoryProductIDs(ids...)
	return _u
}

// RemoveSubcategoryProducts removes "subcategory_products" edges to Product entities.
func (_u *CategoryUpdateOne) RemoveSubcategoryProducts(v ...*Product) *CategoryUpdateOne {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
