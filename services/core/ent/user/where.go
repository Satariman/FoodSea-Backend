...
// OnboardingDone applies equality check predicate on the "onboarding_done" field. It's identical to OnboardingDoneEQ.
func OnboardingDone(v bool) predicate.User {
	return predicate.User(sql.FieldEQ(FieldOnboardingDone, v))
}
...
// OnboardingDoneEQ applies the EQ predicate on the "onboarding_done" field.
func OnboardingDoneEQ(v bool) predicate.User {
	return predicate.User(sql.FieldEQ(FieldOnboardingDone, v))
}

// OnboardingDoneNEQ applies the NEQ predicate on the "onboarding_done" field.
func OnboardingDoneNEQ(v bool) predicate.User {
	return predicate.User(sql.FieldNEQ(FieldOnboardingDone, v))
}
