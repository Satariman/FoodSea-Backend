...
func (_q *OrderStatusHistoryQuery) FirstID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (_q *OrderStatusHistoryQuery) FirstIDX(ctx context.Context) uuid.UUID {
...
func (_q *OrderStatusHistoryQuery) OnlyID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (_q *OrderStatusHistoryQuery) OnlyIDX(ctx context.Context) uuid.UUID {
...
func (_q *OrderStatusHistoryQuery) IDs(ctx context.Context) (ids []uuid.UUID, err error) {
...
func (_q *OrderStatusHistoryQuery) IDsX(ctx context.Context) []uuid.UUID {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
//		GroupBy(orderstatushistory.FieldOrderID).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
//
//	client.OrderStatusHistory.Query().
//		Select(orderstatushistory.FieldOrderID).
//		Scan(ctx, &v)
